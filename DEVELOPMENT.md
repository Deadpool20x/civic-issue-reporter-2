...
```bash
git remote add encore encore://jharkhand-civic-issue-reporter-r442
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/jharkhand-civic-issue-reporter-r442/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/jharkhand-civic-issue-reporter-r442/settings/integrations/github)
